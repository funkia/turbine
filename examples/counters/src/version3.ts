...
import { Component, elements, modelView, list, ModelReturn } from "../../../src";
import {
  Now, Behavior, sample, scan, scanS, Stream, switchStream
...
function* counterListModel({ addCounter, listOut }: ModelInput): Iterator<Now<any>> {
  const
